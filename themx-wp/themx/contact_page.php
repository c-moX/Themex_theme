                ...
                <div class="container">
                    <div class="row">
                        <div class="page_title_banner_cell_text text-center">
                            <h2 class="wow fadeInUp" data-wow-delay="300ms">Contact Us</h2>
                        </div>
                    </div>
                </div><!--container-->
            </div><!--B_latest_news-->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="address_form_themx">
                            <div class="address_form_singlE">
                                <h4>E-Mail</h4>
                                <a href="helloxpart@gmail.com" class="email">helloxpart@gmail.com</a>
                            </div>

                            <div class="address_form_singlE">
                                <h4>Phone Numbers</h4>
                                <p><a href="#" class="phoneNo">+17 784 477 84 44</a></p>
                                <p><a href="#" class="phoneNo">+17 784 477 84 44</a></p>
                            </div>

                            <div class="address_form_singlE">
                                <h4>Location</h4>
                                <p>Themex Park Hello Xpart 88, Orchard St <span>New York</span></p>
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="msg_form wow fadeInRight" data-wow-delay="300ms">
                            <form method="POST" action="contact1.php" onSubmit="alert('Thank you for your feedback!');">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea  name="comments" class="form-control" rows="4" placeholder="Your Comment"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="send_me_ph">
                                            <button class="submit-btn_ph" onclick="window.location.href='http://template.helloxpart.com/picasso/picasso/contact1.php'" type="submit">SEND</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-3">
                                <div class="pull-right_shop_Cart wow fadeInLeft" data-wow-delay="300ms">
                                    <a href="#"><img src="images/logo-x.png" alt=""></a>
                                </div>
                            </div>
                            ...
                            <h5 class="newsneller_subscribe">Subscribe To My Newsletter</h5>
                                <form action="#" method="post">
                                   <div class="thelj">
                                        <input class="submit_cupon" type="email">
                                        <div class="send_btn_cupon">
                                            <input type="button" value="SUBSCRIBE" class="submit_cupon_submit">
                                        </div>
                                    </div>
                                </form>
                            </div>
