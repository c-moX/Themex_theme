...
function themx_theme_register_sidebar() {
    ...
    'description' => __( 'This Is Main Blog Sidebar Widget', 'themx' ),
    ...
    'description' => esc_html__( 'This Is Main Footer Sidebar Widget', 'theme-slug' ),
...
class themx_rcnt_post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__( 'Themx - Recent Post', 'themx' ), // Name
