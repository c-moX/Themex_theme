...
function themx_comment($comment, $args, $depth) {
	...
	<div class="blog_a_text">
		...
		<div class="comment-meta commentmetadata"><p <?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ); ?>>
			<p class="timedate">
				<?php
				/* translators: 1: date, 2: time */
				printf( __('%1$s at %2$s', 'themx' ), get_comment_date(),  get_comment_time() );?></p>
			</p>
