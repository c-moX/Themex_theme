					...
					<article id="post-<?php the_ID(); ?>" <?php post_class($sticky); ?>>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="c_column_digital wow fadeInLeft" data-wow-delay="300ms">
                                <div class="c_column_digital_text">
                                    <div class="top_dj">
                                        <h3><?php echo esc_html($blog_category_txt);?></h3>
                                    </div>
                                    ...
                                    <a href="#" class="apply_digital"><?php echo esc_html($blog_1_read_more);?></a>
                                </div>
                            </div>
                        </div><!--.col-md-4-->
						</article>
...
add_shortcode('cf_7','themx_contact_form');
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-3">
                                <div class="pull-right_shop_Cart wow fadeInLeft" data-wow-delay="300ms">
                                    <a href="#"><img src="<?php echo get_template_directory_uri();?>/images/logo-x.png" alt=""></a>
                                </div>
                            </div>
